...
describe 'Post show page', type: :feature do
    before :each do
      ...
      @user2 = User.create(name: 'LeonardoSaltos', bio: "This is my life", photo: "https://avatars.githubusercontent.com/u/53021807?v=4", email: 'rafael@test.com', password: '123456')
